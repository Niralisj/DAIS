...
import "./diy.css";
// Make sure these image files are in your src/imgs directory
...
const DIY = () => {
  ...
  const [filteredOilyRecipes, setFilteredOilyRecipes] = useState(oilySkinRecipes);
  const [filteredDryRecipes, setFilteredDryRecipes] = useState(drySkinRecipes);
  const [filteredCombinationRecipes, setFilteredCombinationRecipes] = useState(combinationSkinRecipes);
  const [filteredSensitiveRecipes, setFilteredSensitiveRecipes] = useState(sensitiveSkinRecipes);
  ...
  const handleSearch = (event) => {
    ...
    setFilteredOilyRecipes(filterRecipes(oilySkinRecipes));
    setFilteredDryRecipes(filterRecipes(drySkinRecipes));
    setFilteredCombinationRecipes(filterRecipes(combinationSkinRecipes));
    setFilteredSensitiveRecipes(filterRecipes(sensitiveSkinRecipes));
  };
  ...
  return (
    <>
      ...
      <div className="search-filter">
        ...
        />
        {/* You can add more filter options here later */}
      </div>

      <SkinTypeSection title="Oily Skin Remedies" recipes={filteredOilyRecipes} id="oily-skin" showImage={true} />
      <SkinTypeSection title="Dry Skin Remedies" recipes={filteredDryRecipes} id="dry-skin" showImage={true} />
      <SkinTypeSection title="Combination Skin Remedies" recipes={filteredCombinationRecipes} id="combination-skin" showImage={true} />
      <SkinTypeSection title="Sensitive Skin Remedies" recipes={filteredSensitiveRecipes} id="sensitive-skin" showImage={true} />
    </>
  );
};
